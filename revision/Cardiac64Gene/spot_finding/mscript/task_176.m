...
input_path = '/stanley/WangLab/Data/Processed/2022-09-30-Rena-Cardiomyocyte64Gene/';
run_id = '2022-10-05'

input_dim = [2048 2048 31 4 4];
gpu_block = [1024 1024 31 4 4];
